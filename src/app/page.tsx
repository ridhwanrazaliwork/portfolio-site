  ...
  return (
    ...
    >
      ...
      <div className="min-w-0">
        <p className="text-[10px] text-muted-foreground" style={{ fontFamily: "var(--font-jetbrains)" }}>{label}</p>
    ...
    >
          ...
          <div className="glass-panel p-6 md:p-10 flex flex-col md:flex-row items-center gap-8 transition-all duration-300 hover:shadow-[0_0_30px_var(--accent-glow)] hover:border-accent/30 relative">
            ...
            <div className="group relative w-32 h-32 md:w-40 md:h-40 shrink-0">
              ...
              <div
                ...
                className="absolute rounded-full border transition-transform duration-[1.5s] ease-in-out group-hover:-rotate-[360deg]"
              /> */}
              <div className="relative w-full h-full rounded-full overflow-hidden border-2 border-accent/20 shadow-[0_0_15px_var(--accent-glow)] group-hover:shadow-[0_0_25px_var(--accent-glow)] transition-shadow duration-300">
                <Image
                  src={profileImg}
                  alt="Ridhwan"
                  fill
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="mt-1 text-sm text-muted-foreground" style={{ fontFamily: "var(--font-jetbrains)" }}>
      ...
      <section className="pb-24 px-4">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <BentoCard>
            ...
            <div>
              <span
                className="text-xs font-medium uppercase tracking-wider text-muted-foreground block mb-4"
                style={{ fontFamily: "var(--font-jetbrains)" }}
              >
                {"\u276F"} {currentLabel}
              </span>
              ...
              {otherCerts.map((cert, i) => (
                ...
                >
                  <div className="flex items-start justify-between gap-2 mb-1">
                    ...
                    <span className="text-[10px] text-muted-foreground shrink-0" style={{ fontFamily: "var(--font-jetbrains)" }}>({cert.year})</span>
                  </div>
      ...
      <footer className="relative py-32 px-4 overflow-hidden">
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col items-center gap-4 text-muted-foreground mb-10">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              >
                ...
                <span className="text-[10px] text-muted-foreground" style={{ fontFamily: "var(--font-jetbrains)" }}>email</span>
              ...
              >
                ...
                <span className="text-[10px] text-muted-foreground" style={{ fontFamily: "var(--font-jetbrains)" }}>linkedin</span>
              ...
              >
                ...
                <span className="text-[10px] text-muted-foreground" style={{ fontFamily: "var(--font-jetbrains)" }}>github</span>
